        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
          <View style={ds.page}>
            <View style={ds.headerRow}>
              <Text style={ds.pageTitle}>TABLERO</Text>
            ...
            <View style={{ flexDirection: 'row', gap: 18, marginTop: 8, marginBottom: 36 }}>
              <TouchableOpacity style={ds.linkCard} onPress={() => navigation.navigate('Facturas')}>
              ...
              <TouchableOpacity style={ds.linkCard} onPress={() => navigation.navigate('Pedidos')}>
...
const ds = StyleSheet.create({
  ...
  pickerText: { fontSize: 13, fontFamily: 'BarlowCondensed-Bold', color: '#2B2B2B' },
